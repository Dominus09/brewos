...
Registro de decisiones arquitectónicas y de producto de BrewOS. Cada ADR es inmutable una vez aceptado; cambios requieren un nuevo ADR que lo supersede.

| ADR | Título | Estado |
|-----|--------|--------|
| [ADR-0001](ADR-0001-interface-language.md) | Idioma de interfaz vs idioma técnico | Aceptado |
| [ADR-0002](ADR-0002-catalog-before-inventory.md) | Catálogo antes que Inventario | Aceptado |
...
Cada ADR incluye: contexto, decisión, consecuencias, beneficios, riesgos y alternativas consideradas.
